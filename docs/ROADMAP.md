...
- [x] Freeze the primary timing methodology — `wall_deadline_with_hidden_sensitivity`; keep timeout/technical/browser-device implementation checks open until verified.
